...
//         try {
//             String base64Image = productDTO.getSpecification().getImage().split(",")[1]; // Remove the data:image/...;base64, prefix if present
//             byte[] decodedBytes = Base64.getDecoder().decode(base64Image);
...
//         List<Application> applications = productDTO.getApplications().stream().map(docDTO -> {
//             Application application = new Application();
//             application.setApplicationName(docDTO.getApplicationName());
//             application.setFileContent(docDTO.getFileContent());
...
//             docDTO.setFileContent(doc.getFileContent());
//             return docDTO;
//         }).collect(Collectors.toList());
